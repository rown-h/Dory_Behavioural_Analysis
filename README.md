...
| **Measure**         | **Definition**                                                                                                                                                                                                                                                                                          |
|---------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Search strategy     | Score out of 11, based on the sequence of holes the rat's head enters, concluding with its first entry into the EB ROI. Based on [Rodríguez Peris *et al.* (2024)](https://doi.org/10.1016/j.bbr.2023.114730), adapted for use with a 18-hole Barnes maze. A detailed description is shown in Figure 3. |
